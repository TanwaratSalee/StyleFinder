...
class FirebaseService {
  ...
  Future<void> updateAddressForCurrentUser(String userId, String address,
...
class _AddressFormState extends State<AddressForm> {
  ...
  void saveAddressToFirestore() {
    ...
    String postalCode = _postalCodeController.text
        .replaceAll(RegExp(r'\D'), ''); // เพิ่มเฉพาะตัวเลข
    String phone =
        _phoneController.text.replaceAll(RegExp(r'\D'), ''); // เพิ่มเฉพาะตัวเลข
    ...
    if (address.isNotEmpty &&
      ...
      if (_addressController.text.length > 10) {
        FirebaseService().updateAddressForCurrentUser(

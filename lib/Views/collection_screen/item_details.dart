        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            Obx(() => IconButton(onPressed: () {
              ...
              }, icon: Icon(Icons.favorite_outline, color: controller.isFav.value ? primaryApp : fontGreyDark)),
            ),
          ],
        ),
        body: Column(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const CircleAvatar(
                          ...
                          child: Icon(Icons.message_rounded,color: fontBlack),).onTap(() {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              SizedBox(
                                width: 100,
                                child: "Color: ".text.color(fontGreyDark).make(),
                              ),
                              Row(
                          ...
                          Row(
                            children: [
                              SizedBox(
                                width: 100,
                                child: "Quantity: ".text.color(fontGreyDark).make(),
                              ),
                              Obx(() => Row(
                                  children: [
                                    ...
                                    controller.quantity.value.text.size (16).color(fontGreyDark).fontFamily(bold).make(),
                                    IconButton(onPressed: () {
                                      controller.increaseQuantity(int.parse(data['p_quantity']));
                                      controller.calculateTotalPrice(int.parse(data['p_price']));
                                    }, icon: const Icon(Icons.add)),
                                    10.heightBox,
                                    "(${data['p_quantity']} available)".text.color(fontGreyDark).make(),
                                  ],
                          ...
                          Row(
                            children: [
                              SizedBox(
                                width: 100,
                                child: "Totle: ".text.color(fontGreyDark).make(),
                              ),
                              Row(
                                children: [
                                  "${controller.totalPrice.value}".numCurrency.text.color(primaryApp).size(16).fontFamily(bold).make(),
                                ],
                    ...
                    "Description".text.color(fontBlack).fontFamily(semibold).make(),
                    10.heightBox,
                    ...
                    ListView(
                      ...
                      children: List.generate(itemDetailButtonsList.length, (index) => ListTile(
                        title: itemDetailButtonsList[index].text.fontFamily(semibold).color(fontBlack).make(),
                    ...
                    productsyoumaylike.text.fontFamily(bold).size(16).color(fontBlack).make(),
                    10. heightBox,
              ...
              child: ourButton(
                  ...
                  onPress: () {
                    ...
                    VxToast.show(context, msg: "Added to cart");
                      ...
                      VxToast.show(context, msg: "Please select the quantity of products ");
                    }
                  },

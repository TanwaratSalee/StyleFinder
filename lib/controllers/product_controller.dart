...
String getSkinToneDescription(int skinTone) {
  ...
  Map<int, String> getRecommendedColors(String dayOfWeek) {
    switch (dayOfWeek) {
      case 'Sunday':
        return {
          0xFFFF0000: 'สีแดง: สื่อถึงพลังและความมั่นใจ เนื่องจากวันอาทิตย์เป็นวันที่เกี่ยวข้องกับพระอาทิตย์ ซึ่งมีสีแดงเป็นสัญลักษณ์',
          0xFFFFFFFF: 'สีขาว: สื่อถึงความบริสุทธิ์และความสงบ ช่วยเสริมความคิดสร้างสรรค์',
          0xFFFFC0CB: 'สีชมพู: สื่อถึงความรักและความเมตตา ช่วยสร้างความสัมพันธ์ที่ดี',
